...
<head>
    <mete charset="utf-8">
        ...
        <link rel="stylesheet" href="css/gallery-drinks.css">
...
<div class="main">
        <div class="wrapper">
            ...
            <div class="drinks-photo">
                <h1><b><u>Gallery</u></b></h1>
                <div class="drinks-list">
                    <div class="drinks-list-1"><a href="main-1.jsp">Home&ensp;/ &ensp;</a></div>
                    <div class="drinks-list-1"><a href="gallery.jsp">Gallery&ensp;/ &ensp;</a></div>
                    <div class="drinks-list-2">Drinks</div>
                </div>
            </div>
            <div class="drinks-name"> Our Gallery</div>
            <div class="drinks-name" style="color: black;">Drinks</div>
            <br>
            <div class="drinks-photos">
                <div class="drinks-photos-1"><img src="photo/drinks-gallery/Drinks-1.jpg" height="300px"
                        width="300px" /></div>
                <div class="drinks-photos-1"><img src="photo/drinks-gallery/Drinks-2.jpg" height="300px"
                        width="300px" /> </div>
                <div class="drinks-photos-1"><img src="photo/drinks-gallery/Drinks-3.jpg" height="300px"
                        width="300px" /></div>
                <div class="drinks-photos-1"><img src="photo/drinks-gallery/Drinks-4.jpg" height="300px"
                        width="300px" /></div>

            </div>
            <div class="drinks-photos">
                <div class="drinks-photos-1"><img src="photo/drinks-gallery/Drinks-5.jpg" height="300px"
                        width="300px" /></div>
                <div class="drinks-photos-1"><img src="photo/drinks-gallery/Drinks-6.jpg" height="300px"
                        width="300px" /> </div>
                <div class="drinks-photos-1"><img src="photo/drinks-gallery/Drinks-7.jpg" height="300px"
                        width="300px" /> </div>
                <div class="drinks-photos-1"><img src="photo/drinks-gallery/Drinks-8.jpg" height="300px"
                        width="300px" /> </div>
            ...
            <div class="drinks-photos">
                ...
                <div class="drinks-photos-1"><img src="photo/drinks-gallery/Drinks-9.jpg" height="300px"
                        width="300px" /> </div>
            ...
            <div class="footer" id="fsize">
                ...
                <div class="footerbox">
                    ...
                    <p> &emsp;Royal Restaurant Mumbai which takes full advantage of the lands produce; Excellent
                        seafood, fresh fruits, vegetables and fine meat. The food food in Kappad invariably rich and
                        aromatic.
