    ...
    <div class="wrapper">
      ...
      <div class="gallery-photo">
        ...
        <div class="gallery-list">
          <div class="gallery-list-1"><a href="ass2.html">Home&ensp;/ &ensp;</a></div>
          <div class="gallery-list-2">Gallery</div>
        </div>
      </div>
      <div class="gallery-name">Gallery</div>
      <div class="gallery-name" style="color: black;">OUR SPECIALITIES</div>
      <br>
      <div class="gallery-photos">
        <div class="gallery-photos-1"><img src="photo/feature.jpg"  height="300px" width="300px"/></div>
        <div class="gallery-photos-1"><img src="photo/cheaf.jpg"  height="300px" width="300px"/> </div>
        <div class="gallery-photos-1"><img src="photo/drinks.jpg" height="300px" width="300px"/></div>
        <div class="gallery-photos-1"><img src="photo/restaurant.jpg" height="300px" width="300px"/></div>
      </div>
      <div class="lable">
        <div class="lable-1"><button><a href="gallery-food.jsp" target="_blank"> Featured Food</a></button></div>
        <div class="lable-1"> <button><a href="gallery-chefs.jsp" target="_blank"> chef specials</a></button></div>
        <div class="lable-1"> <button><a href="gallery-drinks.jsp" targrt="_blank"> Drinks</a></button></div>
        <div class="lable-1"> <button><a href="gallery-restaurant.jsp" targrt="_blank"> Restaurant</a></button></div>
