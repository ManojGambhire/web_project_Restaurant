...
<head>
  <mete charset="utf-8">
    ...
    <link rel="stylesheet" href="css/gallery-chefs.css">
    ...
    <div class="wrapper">
      ...
      <div class="chefs-photo">
        ...
        <div class="chefs-list">
          <div class="chefs-list-1"><a href="main-1.jsp">Home&ensp;/ &ensp;</a></div>
          <div class="chefs-list-1"><a href="gallery.jsp">Gallery&ensp;/ &ensp;</a></div>
          <div class="chefs-list-2">Chefs Special</div>
        </div>
      </div>
      <div class="chefs-name"> Our Gallery</div>
      <div class="chefs-name" style="color: black;">Chefs Special</div>
      <br>
      <div class="chefs-photos">
        <div class="chefs-photos-1"><img src="photo/chef-gallery/chef-1.jpg"  height="300px" width="300px"/></div>
        <div class="chefs-photos-1"><img src="photo/chef-gallery/chef-2.jpg"  height="300px" width="300px"/> </div>
        <div class="chefs-photos-1"><img src="photo/chef-gallery/chef-3.jpg" height="300px" width="300px"/></div>
        <div class="chefs-photos-1"><img src="photo/chef-gallery/chef-4.jpg" height="300px" width="300px"/></div>
       
      </div>
      <div class="chefs-photos">
        <div class="chefs-photos-1"><img src="photo/chef-gallery/chef-5.jpg"  height="300px" width="300px"/></div>
        <div class="chefs-photos-1"><img src="photo/chef-gallery/chef-6.jpg"  height="300px" width="300px"/> </div>
        <div class="chefs-photos-1"><img src="photo/chef-gallery/chef-7.jpg" height="300px" width="300px"/></div>
        <div class="chefs-photos-1"><img src="photo/chef-gallery/chef-8.jpg" height="300px" width="300px"/></div>
