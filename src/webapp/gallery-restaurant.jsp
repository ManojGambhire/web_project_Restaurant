...
<head>
    <mete charset="utf-8">
        ...
        <link rel="stylesheet" href="css/gallery-restaurant.css">
        ...
        <div class="wrapper">
            ...
            <div class="restaurant-photo">
                ...
                <div class="restaurant-list">
                    <div class="restaurant-list-1"><a href="main-1.jsp">Home&ensp;/ &ensp;</a></div>
                    <div class="restaurant-list-1"><a href="gallery.jsp">Gallery&ensp;/ &ensp;</a></div>
                    <div class="restaurant-list-2">Restaurant</div>
                </div>
            </div>
            <div class="restaurant-name"> Our Gallery</div>
            <div class="restaurant-name" style="color: black;">Restaurant</div>
            <br>
            <div class="restaurant-photos">
                <div class="restaurant-photos-1"><img src="photo/restaurant-gallery/restaurant-1.jpg" height="300px"
                        width="300px" /></div>
                <div class="restaurant-photos-1"><img src="photo/restaurant-gallery/restaurant-2.jpg" height="300px"
                        width="300px" /> </div>
                <div class="restaurant-photos-1"><img src="photo/restaurant-gallery/restaurant-3.jpg" height="300px"
                        width="300px" /></div>
                <div class="restaurant-photos-1"><img src="photo/restaurant-gallery/restaurant-4.jpg" height="300px"
                        width="300px" /></div>

            </div>
            <div class="restaurant-photos">
                <div class="restaurant-photos-1"><img src="photo/restaurant-gallery/restaurant-5.jpg" height="300px"
                        width="300px" /></div>
                <div class="restaurant-photos-1"><img src="photo/restaurant-gallery/restaurant-6.jpg" height="300px"
                        width="300px" /> </div>
            </div>
