...
<div class="main">
    <div class="wrapper">
      ...
      <div class="menu-photo">
        <h1><b><u>Food Menu</u></b></h1>
        <div class="menu-list">
          <div class="menu-list-1"><a href="ass2.html">Home&ensp;/ &ensp;</a></div>
          <div class="menu-list-2">Food menu</div>
        </div>
      </div>
      <div class="menu-name">MENU</div>
      <div class="menu-name" style="color: black;">OUR SPECIALITIES</div>
      <div class="menu-card">
        <div class="menu-card-1"><img src="photo/lunch-image.jpg"  height="300px" width="300px"/></div>
        <div class="menu-card-1"><img src="photo/non-veg.jpg"  height="300px" width="300px"/> </div>
        <div class="menu-card-1"><img src="photo/drinks-image.jpg" height="300px" width="300px"/></div>
      </div>
      <div class="lable">
        <div class="lable-1"><button><a href="photo/veg food.pdf" target="_blank"> Veg Food</a></button></div>
        <div class="lable-1"> <button><a href="photo/nonveg food.pdf" target="_blank"> Non-veg Food</a></button></div>
        <div class="lable-1"> <button><a href="photo/drinks.pdf" target="_blank"> Drinks</a></button></div>
