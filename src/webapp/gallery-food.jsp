...
<head>
  <mete charset="utf-8">
    ...
    <link rel="stylesheet" href="css/gallery-food.css">
...
<div class="main">
    <div class="wrapper">
      ...
      <div class="food-photo">
        <h1><b><u>Gallery</u></b></h1>
        <div class="food-list">
          <div class="food-list-1"><a href="main-1.jsp">Home&ensp;/ &ensp;</a></div>
          <div class="food-list-1"><a href="gallery.jsp">Gallery&ensp;/ &ensp;</a></div>
          <div class="food-list-2">Featured Food</div>
        </div>
      </div>
      <div class="food-name"> Our Gallery</div>
      <div class="food-name" style="color: black;">Featured Food</div>
      <br>
      <div class="food-photos">
        <div class="food-photos-1"><img src="photo/food-gallery/food-1.jpg"  height="300px" width="300px"/></div>
        <div class="food-photos-1"><img src="photo/food-gallery/food-2.jpg"  height="300px" width="300px"/> </div>
        <div class="food-photos-1"><img src="photo/food-gallery/food-3.jpg" height="300px" width="300px"/></div>
        <div class="food-photos-1"><img src="photo/food-gallery/food-4.jpg" height="300px" width="300px"/></div>
       
      </div>
      <div class="food-photos">
        <div class="food-photos-1"><img src="photo/food-gallery/food-5.jpg"  height="300px" width="300px"/></div>
        <div class="food-photos-1"><img src="photo/food-gallery/food-6.jpg"  height="300px" width="300px"/> </div>
        <div class="food-photos-1"><img src="photo/food-gallery/food-7.jpg" height="300px" width="300px"/></div>
        <div class="food-photos-1"><img src="photo/food-gallery/food-8.jpg" height="300px" width="300px"/></div>
       
      </div>
      <div class="food-photos">
        <div class="food-photos-1"><img src="photo/food-gallery/food-9.jpg"  height="300px" width="300px"/></div>
        <div class="food-photos-1"><img src="photo/food-gallery/food-10.jpg"  height="300px" width="300px"/> </div>
        <div class="food-photos-1"><img src="photo/food-gallery/food-11.jpg" height="300px" width="300px"/></div>
        <div class="food-photos-1"><img src="photo/food-gallery/food-12.jpg" height="300px" width="300px"/></div>
      ...
      <div class="contac-1"><img src="photo/email-symbolpng.png" height="200px" width="200px"/>
        <h2>Email</h2>  
        <p>
          Get In Touch:- <br><a href="https://mail.google.com/mail/u/0/#inbox" target="_blank">manojgambhire71@gmail.com</a></p></div>
      <div class="contac-1"><img src="photo/address-symbol.jpg" height="200px" width="200px"/>
        <h2>Address</h2>  
        <p>
          21 A High Street High<br> Wycombe HP11 2BE</p></div>
      </div>
